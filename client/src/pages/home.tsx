      ...
      <section className="relative h-[70vh] bg-gray-800 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl">
            {/* Yellow Header Text */}
            <div className="mb-4">
              <span className="text-yellow-400 text-lg font-medium tracking-wide">
            ...
            <p className="text-white/90 mb-8 text-lg leading-relaxed">
              Licensed and Trained Security Guards Free Consultations 50 Years of Combined Experience
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold px-8 py-4 text-lg transition-all duration-300"
                onClick={handleGetStarted}
              >
                {customer ? 'Go to Dashboard' : 'BOOK A FREE AUDIT'}
              </Button>
